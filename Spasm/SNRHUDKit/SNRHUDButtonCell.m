...
#define SNRButtonBlueGradientBottomColor          [NSColor colorFromHexadecimalValue:@"653ea8"]
#define SNRButtonBlueGradientTopColor             [NSColor colorFromHexadecimalValue:@"9473ce"]
#define SNRButtonBlueHighlightColor               [NSColor colorWithDeviceWhite:1.000 alpha:0.250]

#define SNRButtonTextFont                         [NSFont systemFontOfSize:13.f]
...
#define SNRButtonBorderColor                      [NSColor colorFromHexadecimalValue:@"2b0c61"]
...
- (NSRect)snr_drawButtonTitle:(NSAttributedString*)title withFrame:(NSRect)frame inView:(NSView*)controlView
{
    ...
    NSRect labelRect = NSMakeRect(NSMidX(frame) - (labelSize.width / 2.f), NSMidY(frame) - (labelSize.height / 2.f) + 1, labelSize.width, labelSize.height);
